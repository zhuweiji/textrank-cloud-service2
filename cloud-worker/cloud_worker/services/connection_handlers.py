...
from cloud_worker.constants import RABBITMQ_CONNECTION_URL, RABBITMQ_JOB_QUEUE_NAME
...
class RabbitMQHandler:
    ...
    @classmethod
    async def publish(cls, queue_name:str, message: Union[str, BinaryIO, bytes], headers=None) -> None:
        headers = headers or {}
